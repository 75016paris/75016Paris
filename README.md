...
### Comptoir — AI restaurant workforce planning SaaS

Vertical SaaS for restaurants: web dashboard + WhatsApp assistant to manage schedules, teams, hours, holidays, replacements and HR constraints.

**Shows:** applied AI product building, APIs, LLM tool-calling, permissions, planning solver, deployment.  
